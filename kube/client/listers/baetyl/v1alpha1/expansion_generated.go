...
// ApplyListerExpansion allows custom methods to be added to
// ApplyLister.
type ApplyListerExpansion interface{}

// ApplyNamespaceListerExpansion allows custom methods to be added to
