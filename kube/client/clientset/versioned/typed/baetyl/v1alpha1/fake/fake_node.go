...
var nodesResource = schema.GroupVersionResource{Group: "baetyl.apis", Version: "v1alpha1", Resource: "nodes"}

var nodesKind = schema.GroupVersionKind{Group: "baetyl.apis", Version: "v1alpha1", Kind: "Node"}
