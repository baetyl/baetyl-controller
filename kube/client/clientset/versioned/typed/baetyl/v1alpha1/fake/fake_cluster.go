...
var clustersResource = schema.GroupVersionResource{Group: "baetyl.apis", Version: "v1alpha1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "baetyl.apis", Version: "v1alpha1", Kind: "Cluster"}
