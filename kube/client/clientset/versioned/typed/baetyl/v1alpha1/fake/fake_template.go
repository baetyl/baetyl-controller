...
var templatesResource = schema.GroupVersionResource{Group: "baetyl.apis", Version: "v1alpha1", Resource: "templates"}

var templatesKind = schema.GroupVersionKind{Group: "baetyl.apis", Version: "v1alpha1", Kind: "Template"}
